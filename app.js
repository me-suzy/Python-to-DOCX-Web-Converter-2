...
# Creăm un namespace pentru codul utilizatorului
user_namespace = {}
`);
        
        // Encodăm codul în base64
...
if doc is None:
    raise ValueError("Nu s-a găsit nicio variabilă Document (doc) în cod!")
